...
This dashboard tracks a **subset of the federal recovery funds** appropriated by the CARES Act, Consolidated Appropriations Act, and American Rescue Plan Act flowing into the City of Chicago, Cook County, and the State of Illinois. Funds tracked here align with The Chicago Community Trust’s key priorities: community investment, community safety, household investment, housing, and workforce development, which are all vital to narrowing the Chicago region’s racial and ethnic wealth gap. 

The dashboard primarily tracks appropriations, or how much funding the federal government has committed to providing local jurisdictions. For a few select programs where information is available, the dashboard also explores spending by zip code.


We will add more program allocation and spending information as new data become available. For more information, see our [Frequently Asked Questions](./FAQ.html) and [Glossary](./glossary.html).
...
write_csv(data_all, here("data/intermediate_data",
