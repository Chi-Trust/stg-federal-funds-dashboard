...
data_all <-
  ...
  mutate(topic = if_else(topic == "Household Investements", "Household Investement", topic))
...
plot_difference_in_allocation_vs_spending <- function(data, geography) {
  ...
  p <- ggplot(original_allocation_vs_spending) +
    ...
    labs(
      y = "Percentage share of expenditures relative to original allocation"
    ) +
    coord_flip() +
    theme(
...
## Allocated Funds Spent by Topic {.tabset .tabset-pills}
